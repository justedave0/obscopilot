...
class SimpleMainWindow(QMainWindow):
    ...
    def _connect_to_obs(self):
        ...
        try:
            ...
            if result != 0:  # Non-zero result means connection failed
                raise Exception(f"Could not connect to {host}:{port}. Please check if OBS is running with WebSocket server enabled.")
    ...
    def _auto_connect_services(self):
        ...
        # Update status display for already authenticated accounts
        self._update_authentication_status()
